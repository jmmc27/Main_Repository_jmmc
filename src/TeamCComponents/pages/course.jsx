    ...
    <>
      ...
      <div className="container mt-4 mx-auto" id="c_course_maincontainer">
        ...
        <h2
          ...
          style={{ fontWeight: "bold", fontSize: "2rem", color: "#0A0D0C" }}
        >
          My Courses
        </h2>
          ...
          return (
            <div key={idx} id="c_course_courses">
              ...
              <div className="c_course_cardmain">
                ...
                >
                  <div className="c_chapter_cardtxt">
                    <div>
                      <svg
                  ...
                  <div id="c_course_inst" style={{textAlign: 'right', fontSize: '12px', color: '#808080'}}>by: Instructor</div>
                </Link>
              </div>
              <hr className="ln" />
            </div>
